...
export const HomePage: React.FC = () => {
	...
	const handleBulkDelete = async () => {
		if (selectedLanguages.length > 0 && token) {
			try {
				...
				setError("Failed to delete selected languages");
			}
		}
	};
	...
	const user = {
		...
		email:
			username === "elvis"
				? "elvis.e.muresan@gmail.com"
				: "florinpentru0306@gmail.com",
	};
				...
				<Table>
					...
					<TableHeader>
						<TableRow>
							...
							<TableHead className="text-center">
								<Button variant="ghost" onClick={() => handleSort("creator")}>
									Creator
									<ArrowUpDown className="ml-2 h-4 w-4" />
								</Button>
							</TableHead>
							...
							<TableHead className="text-center">
								<Button variant="ghost" onClick={() => handleSort("paradigm")}>
									Paradigm
									<ArrowUpDown className="ml-2 h-4 w-4" />
								</Button>
							</TableHead>
			...
			>
				<DialogContent>
					<DialogHeader>
						...
						<DialogDescription>
							Are you sure you want to delete the selected languages? This
